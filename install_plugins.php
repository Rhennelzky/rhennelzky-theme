...
function my_theme_register_required_plugins() {
  ...
  $plugins = array(
    ...
    array(
      'name'               => 'HTML Editor Syntax Highlighter', // The plugin name.
      'slug'               => 'html-editor-syntax-highlighter', // The plugin slug (typically the folder name).
      //'source'             => 'https://wordpress.org/plugins/html-editor-syntax-highlighter/html-editor-syntax-highlighter.2.4.2.zip', // The plugin source.
